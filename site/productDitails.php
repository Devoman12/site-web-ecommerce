...
if (isset($_GET['product_id'])){
    $product = selectOne($table, ['availability' => 1, 'id' => $_GET['product_id']]);
    $product_brand = selectOne($table1, ['id' => $product['brand']]);
    $product_category = selectOne($table2, ['id' => $product['category']]);
}
					...
					<div class="product-details"><!--product-details-->
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								...
								<p><b>category : </b> <?php echo $product_category['category_name']; ?></p>
								<p><b>Condition:</b> <?php echo $product['condition']; ?></p>
								<p><b>Brand:</b> <?php echo $product_brand['brand_name']; ?></p>
